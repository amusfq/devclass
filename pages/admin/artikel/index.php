  ...
  <div class="col">
    <div class="card shadow">
      <table class="table table-striped table">
        ...
        <tbody>
          <?php
          $query = mysqli_query($koneksi, "SELECT artikel.*, user.nama FROM artikel LEFT JOIN user ON user.id=artikel.penulis");
          ...
          <tr>
            ...
            <td class='align-middle text-center'>
                ...
                <button class="btn btn-danger" onclick='deleteArtikel("artikel", <?= $item["id"] ?>)'>Delete</button>
            </td>
          </tr>
            <?php   
              }
