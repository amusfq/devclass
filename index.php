...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    if (isset($email)) {
                        echo '
                        <li class="nav-item">
                        <a href="pages/admin/index.php" class="nav-link ms-3 text-warning"><i class="fa fa-user"></i> ' . $user_info['nama'] . '</a>
                        </li>';
                    } else {
                        echo '
                        <li class="nav-item">
    ...
    <div class="container py-5">
      ...
      <section class='my-5'>
        ...
        <div class="row">
        <?php
            $query = mysqli_query($koneksi, "SELECT artikel.*, user.nama FROM artikel LEFT JOIN user ON user.id=artikel.penulis LIMIT 6");
